...
\begin{enumerate}[label=\alph*)]
    \item
          Elke begrensde rij heeft een convergente deelrij. We kijken dus eerst of de rij begrensd is, merk op:
    ...
    \item
          Voor alle $M \in \R$ geldt dat er een $n > M$, volgens de archimedische eigenschap.
          Dit betekent dus dat de rij onbegrensd is en dus divergent.
\end{enumerate}
